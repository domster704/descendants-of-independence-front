...
import * as styles from "./ArchiveTop.module.css";
        ...
        <Wrapper>
            <div className={styles.top}>
                ...
                <div className={styles.top_left_and_right + " " + styles.years_and_card}>
                    <WinnerYearCardList years={years} max_years={YEARS_ON_PAGE}/>
                    <WinnerCardFiltered winner_img={winner_img}/>
                </div>
                <div className={styles.top_bottom_block}>
                    <YearPagination years_count={years.length}/>
                    <Link to="/" className={styles.show_all_winner_button}>Список победителей</Link>
                </div>
            </div>
        </Wrapper>
    );
