...
import { setLanguage } from "../../../../store/gallerySlice";
            ...
            <ArrowButton
              ...
              onClick={() => {
                galleryListRef.current.scroll({
                  left:
                    galleryListRef.current.scrollLeft -
                    constants.GALLERY_ELEMENT_WITH_GAP_WIDTH_PX,
                  behavior: "smooth",
                });
              }}
            />
        ...
        <div className={styles.gallery_list_block}>
          <div ref={galleryListRef} className={styles.gallery_list}>
            {galleryStore.galleryList.map((item, index) => {
              if (
                galleryOptions.currentOption.value !== "all" &&
                galleryOptions.currentOption.value !== item.type
              ) {
                return null;
              }
              return (
